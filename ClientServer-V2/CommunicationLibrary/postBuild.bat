...
if "%user_profile:~-4%"=="%user_folder%" (
	cd "C:\Users\m4ss\source\repos\mssevov18\ClientServerAPI\ClientServer-V2\CommunicationLibrary"
	xcopy ".\bin\Release\net6.0\CommunicationLibrary.dll" "..\..\..\..\..\..\Documents\libraries\CommunicationLibrary.dll" /Y
	xcopy ".\bin\Release\net6.0\CommunicationLibrary.dll" "..\..\..\..\Thesis2023\2223-otj-12-project-repo-csharp-mssevov18\libraries\CommunicationLibrary.dll" /Y
) else (
